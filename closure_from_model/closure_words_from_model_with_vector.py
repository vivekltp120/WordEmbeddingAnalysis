...
def generate():
    ...
    if args.vocab_file:
        split_name=args.vocab_file.split('_')
        print(split_name)
        outfile_name=str(split_name[0])+'_'+str(split_name[1])+'_'+'closure_words_'+current_time+'.txt'
        print(outfile_name)
...
def distance(W, vocab, ivocab, input_term):
    for idx, term in enumerate(input_term.split(' ')):
        if term in vocab:
            ...
            print('Vector For Word:' + repr(vectors[term]) )
